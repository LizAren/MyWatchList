...
<body>
    ...
    <div class="grid-wrapper">
        ...
        <main class="gbox1 reveal">
            ...
            if (isset($_GET["submit"]) && $_GET['search'] != NULL) {
                $str = $_GET["search"];
                // $sth = $pdo->prepare("SELECT * FROM 'utente' WHERE nome='$str'");
                $query = "SELECT *
                FROM elemento
                WHERE titolo LIKE :Serchelement";
                $values = array('Serchelement' => '%' . $str . '%');
                /* esecuzione query */
                try {
                    //prepare query
            ...
            ?>
                    ...
                    <center>
                        <div class="AggiungiS">
                            <img src="../Multimedia/404.png" alt=""><br>
                            <h2><a href="Add.php" >Aggiungi</a></h2>
                        </div>
                    </center>
            <?php
                }
